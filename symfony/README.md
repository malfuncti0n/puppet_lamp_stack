...
1. [Setup - The basics of getting started with symfony](#setup)
    * [What symfony affects](#what-symfony-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with symfony](#beginning-with-symfony)
